...
1. Unaware
2. Encounter / awareness
3. Confrontation / warning
4. Engagement 

Keys to neutrality:
- keeping distance
- concealment:
	- scent -- position downwind
...
**Grade 1**: *Nature walk*. Avoiding potentially dangerous animals.
	- smaller animals
**Grade 2**: Viewing certain high profile animals on foot
	- elephant bulls (not in musth)
	- buffalo herds (no dagga boys)
	- rhino, calves once weaned (~6-12 months)
